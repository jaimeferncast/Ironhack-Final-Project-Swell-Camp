  ...
  return (
    <Card className={clsx(props.className, classes.card)}>
      <Grid container>
        ...
        <Typography>Alojamiento: {props.accommodation === "none" /* TO-DO util para cambiar alojmiento y que no salga en cameCase */ ? "Sólo clases" : props.accommodation}&emsp;|&emsp;</Typography>
